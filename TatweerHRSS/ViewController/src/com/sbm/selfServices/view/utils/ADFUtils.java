...
public class ADFUtils {
    ...
    public static Object getSelectOneChoiceValue(String index,
                                                String bindingName,
        ...
        Row fromList = (Row)list.getValueFromList(Integer.parseInt(index));
                Object value = fromList.getAttribute(attributeName);
...
//            (JUCtrlListBinding)bindings.get(bindingName);
//        Object value = null;
