...
public class JSFUtils {
    ...
    public static void addFacesWarnMessage(String attrName, String msg) {
        FacesContext ctx = getFacesContext();
        FacesMessage fm = 
   ...
   */
    ...
    public static String getMessageFromBundle(String key) {
        //ResourceBundle bundle = getBundle();
        //
        oracle.javatools.resourcebundle.ChainedKeyValueMap bundle = (oracle.javatools.resourcebundle.ChainedKeyValueMap)resolveExpression("#{adfBundle['com.oracle.ida.view.ViewControllerBundle']}");
