...
public class GetXDOSchemaInSessionResponse {
    ...
    /**
     * Gets the value of the getXDOSchemaInSessionReturn property.
     * 
     * @return
     *     possible object is
     *     byte[]
    ...
    /**
     * Sets the value of the getXDOSchemaInSessionReturn property.
     * 
     * @param value
     *     allowed object is
     *     byte[]
    ...
    public void setGetXDOSchemaInSessionReturn(byte[] value) {
        this.getXDOSchemaInSessionReturn = ((byte[]) value);
    }
